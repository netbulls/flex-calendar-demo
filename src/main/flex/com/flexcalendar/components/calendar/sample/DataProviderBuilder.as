...
public class DataProviderBuilder
{
	...
	public function addHolidays(itemSet:ICalendarItemSet):void
	{

		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(0, 0, 24, "Holiday", false), ItemType.UNAVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(6, 0, 24, "Holiday", false), ItemType.UNAVAILABLE_SPACE));
	}

	private function setItemAsReadonlySpace(item:ICalendarItem, type:int):ICalendarItem
	{
		item.itemType = ItemType.UNAVAILABLE_SPACE;
		item.readOnly = true;
		return item;
	}
	...
	public function addWorkingHours(itemSet:ICalendarItemSet):void
	{
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(1, 8, 16, "Available", false,
				RendererColorsFactory.buildColors(RendererColors.YELLOW)), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(1, 18, 20, "Available", false), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(2, 8, 16, "Available", false), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(3, 8, 16, "Available", false), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(3, 18, 20, "Available", false), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(4, 8, 16, "Available", false), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(5, 8, 16, "Available", false), ItemType.AVAILABLE_SPACE));
		itemSet.addItem(setItemAsReadonlySpace(buildItemWithDay(5, 18, 20, "Available", false), ItemType.AVAILABLE_SPACE));
	}
	...
	public function testRecur():void
	{
		...
		if (stringRecur != recur10.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur10.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur11.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur11.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur12.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur12.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur13.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur13.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur14.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur14.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur15.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur15.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur16.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur16.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur17.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur17.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur18.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur18.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur19.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur19.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur20.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur20.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur21.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur21.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur22.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur22.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur23.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur23.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur24.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur24.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur25.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur25.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur26.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur26.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur27.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur27.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur28.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur28.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur29.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur29.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur30.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur30.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur31.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur31.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur32.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur32.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur33.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur33.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur34.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur34.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur35.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur35.buildRecurString());
		else
			trace(stringRecur + " OK!");
		...
		if (stringRecur != recur35.buildRecurString())
			trace("BuildRecurString returned wrong data. Expected: " + stringRecur + " , returned: " + recur36.buildRecurString());
		else
			trace(stringRecur + " OK!");
